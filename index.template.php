...
function template_body_above()
{
	...
	if (empty($settings['images_url']))
		echo '
					<span style="font-family: Verdana, sans-serif; font-size: 140%; ">', $context['forum_name'], '</span>';
	else
		echo '
					<a href="'.$scripturl.'" title="', $context['forum_name'], '"><img src="', $context['header_logo_url_html_safe'], '" style="display:block; margin: auto;" alt="', $context['forum_name'], '" /></a>';


	echo '</div><div id="tborder">'; // todo maybe move the dropdown generated by profile to the middle section
	echo '<div style="font-size: 85%"> 
		<div class="catbg">
			<h3 id="forum_name">', $context['forum_name'], '</h3>
		</div>
		<ul id="greeting_section" class="topbg">
			<li id="time" class="smalltext floatright">
				<time datetime="', smf_gmstrftime('%FT%TZ'), '">', $context['current_time'], '</time>
			</li>
			<li id="name">Welcome, <em>', $context['user']['name'], '</em></li>
		</ul>
	...
	echo (!empty($settings['custom_forum_width'])) ? '<div class="bordercolor" style="max-width: ' . $settings['custom_forum_width'] . '">' : '<div class="bordercolor">';
	...
	if ($context['user']['is_logged'])
	{
		...
		echo '<span class="textmenu">', $context['user']['name'], '</span></a>
					<div id="profile_menu" class="top_menu bordercolor"></div>
				</li>';
		...
		// Additional buttons for unread stuff
		echo '
				<li>
	...
	echo '<div class="topbg" id="news_section">';
...
function template_body_below()
{
	...
	echo (!empty($settings['custom_forum_width'])) ? '<div id="footer" style="max-width: ' . $settings['custom_forum_width'] . '">' : '<div id="footer">';
	echo '
	...
	echo '
		<ul style="text-align: center;">
			<li class="copyright">', theme_copyright(), ' | <span class="themecopyright">BurntRain based off the theme <a href="https://www.simplemachines.org/community/index.php?action=profile;u=218416">Burnt by: TwitchisMental</a> and <a href="https://custom.simplemachines.org/index.php?theme=2216">Dark Rain V3 20g by: Crip</a></span></li>
